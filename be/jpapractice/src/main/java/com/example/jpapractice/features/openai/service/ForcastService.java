...
public class ForcastService {
    ...
    public List<ForcastResponseDTO> connection(ForcastRequestDTO request) {
        System.out.println("fcst service connection param : " + request);
        ...
        try {
            ...
            System.out.println("fcst service connection status : " + status);
    ...
    public List<ForcastResponseDTO> readString(InputStream stream) throws Exception {
        ...
        System.out.println("fcst service readString result : " + result.toString());
        br.close();
